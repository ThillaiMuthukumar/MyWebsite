...
// JavaScript code to rotate the images
let slideIndex = 0;
...
function toggleTheme() {
    ...
    // Check the current theme and update the button text accordingly
...
// Attach the toggleTheme function to the click event of the button
